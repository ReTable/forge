...
export class BuildCommand extends Command {
  ...
  public static override usage = Command.Usage({
    ...
    details: `
      ...
      The \`-h,--css-class-prefix\` option defines usage of prefix for CSS classes which generates by the CSS modules and
  ...
  private readonly cssClassPrefix = Option.String('-h,--css-class-prefix', {
    description:
      'Prefix which used for CSS classes which generated by CSS Modules and `vanilla-extract` in production mode (default: true)',
